...
7. Offline pack present: `ls ~/Documents/first-breath/docs/stage/` → slide-01…10.png, deck.pdf, quick-output.png, ask-output.png, page-reveal.png, page-final-scene-*.png.
