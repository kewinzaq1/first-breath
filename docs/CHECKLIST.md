...
7. Offline pack present: `ls ~/Documents/first-breath/docs/stage/` → show-scene-1…9.png, slide-01…10.png, deck.pdf, quick-output.png, ask-output.png, page-reveal.png, page-final-scene-*.png. The show itself is one local file — it runs without wifi (system fonts if Google Fonts can't load).
